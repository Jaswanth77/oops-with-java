    ...
    void AptNoError(){
        try
        {
            if(apt_no.length()==3)
                ...
                throw new exp6.ApartmentException("Apartment Number is Invalid");
        }
        catch(exp6.ApartmentException e)
        {
    ...
    void BedsError()
    {
        try
        {
            if(beds>1 && beds<4)
                ...
                throw new exp6.ApartmentException("Bed count is Invalid");
        }
        catch(exp6.ApartmentException e)
        {
            System.out.println(e);
    ...
    void RentError()
    {
        try
        {
            if(rent>500 && rent<2500)
                ...
                throw new exp6.ApartmentException("Rent is Invalid");
        }
        catch(exp6.ApartmentException e)
        {
            System.out.println(e);
